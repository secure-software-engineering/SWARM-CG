...
def setup_logger():
    """logger for litellm callgraph runner"""
    logger = logging.getLogger("litellm_runner")
    logger.setLevel(logging.DEBUG)

    if is_running_in_docker():
        file_handler = logging.FileHandler("/tmp/litellm_callgraph_log.log", mode="w")
    else:
        file_handler = logging.FileHandler("litellm_callgraph_log.log", mode="w")
