...
if __name__ == "__main__":
    ...
    folder_path = SCRIPT_DIR / "dataset" / "pycg"
    output_file_gpt = SCRIPT_DIR / "ft_dataset" / "finetuning_autoset_gpt_v1.5.jsonl"
    output_file_llama = (
        SCRIPT_DIR / "ft_dataset" / "finetuning_autoset_llama_v1.5.jsonl"
    )
